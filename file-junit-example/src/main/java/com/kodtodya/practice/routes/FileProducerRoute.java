...
public class FileProducerRoute extends RouteBuilder{
	...
	public void configure() throws Exception {
		from("direct:my-direct-component").id("direct-consumer")
				// log statement
				...
				.to("file:{{output.location}}?fileName=camel-session-out.txt&fileExist=Append&charset=utf-8").id("file-producer");
	}
